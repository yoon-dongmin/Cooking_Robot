###########################################################
test_file_name = 'test_35_predict_v2.csv'
...
obj_place.append(['chopped_celery', 'chopped_celery', 'deactivate', 'deactivated'])

# for Spread (removed)
# obj_place.append(['spread_butter', 'spread_butter', 'deactivate', 'deactivated'])

# for Pour (removed if poured on)
obj_place.append(['relish_1', 'sugar', 'deactivate', 'deactivated'])
