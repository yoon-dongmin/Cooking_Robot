###########################################################
test_file_name = 'test_62_predict_v2.csv'
...
obj_state.append(['garlic_bread1', 'garlic_bread', ['exist']])
obj_state.append(['garlic_bread2', 'garlic_bread', ['exist']])
obj_state.append(['garlic_bread3', 'garlic_bread', ['exist']])
obj_state.append(['turkey', 'turkey', ['exist']])
obj_state.append(['cheese', 'cheese', ['exist']])
obj_state.append(['escarole', 'escarole', ['exist']])
...
obj_place.append(['garlic_bread1', 'garlic_bread', 'table1_ingredient_area', 'activated'])
obj_place.append(['garlic_bread2', 'garlic_bread', 'table1_ingredient_area', 'activated'])
obj_place.append(['garlic_bread3', 'garlic_bread', 'table1_ingredient_area', 'activated'])
...
obj_place.append(['escarole', 'escarole', 'table1_ingredient_area', 'activated'])
