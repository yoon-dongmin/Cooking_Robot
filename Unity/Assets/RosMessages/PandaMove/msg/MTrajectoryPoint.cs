...
{
    public class MTrajectoryPoint : Message
    {
        public const string RosMessageName = "panda_move/TrajectoryPoint";
        ...
        public MTrajectoryPoint(double[] positions, double[] velocities, double[] accelerations, double[] effort, MDuration time_from_start)
        {
