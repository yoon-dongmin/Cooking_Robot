...
{
    public class MPlanningSceneComponents : Message
    {
        ...
        public MPlanningSceneComponents()
        {
            this.components = 0;
        }

        public MPlanningSceneComponents(uint components)
        {
        ...
        {
            return "MPlanningSceneComponents: " +
