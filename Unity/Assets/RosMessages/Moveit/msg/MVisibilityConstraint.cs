...
{
    public class MVisibilityConstraint : Message
    {
        ...
        public Geometry.MPoseStamped target_pose;
        ...
        public Geometry.MPoseStamped sensor_pose;
        ...
        public MVisibilityConstraint()
        {
            this.target_radius = 0.0;
            this.target_pose = new Geometry.MPoseStamped();
            this.cone_sides = 0;
            this.sensor_pose = new Geometry.MPoseStamped();
        ...
        public MVisibilityConstraint(double target_radius, Geometry.MPoseStamped target_pose, int cone_sides, Geometry.MPoseStamped sensor_pose, double max_view_angle, double max_range_angle, byte sensor_view_direction, double weight)
        {
